...
(opencv_deps['include_dirs']).append('/root/ocv-tmp/opencv-2.4.13.6/release/modules/python')
(opencv_deps['include_dirs']).append('/root/ocv-tmp/opencv-2.4.13.6/modules/python/src2')
