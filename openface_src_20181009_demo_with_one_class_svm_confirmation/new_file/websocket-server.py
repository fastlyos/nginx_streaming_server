...
class OpenFaceServerProtocol(WebSocketServerProtocol):
    ...
    def onMessage(self, payload, isBinary):
        ...
        if msg['type'] == "ALL_STATE":
            ...
            self.ppl_oneclasssvm_clf.append(svm.OneClassSVM(nu=0.8))
            ...
            aug_ratio = 1
            if isWithAug and len(img_list_dataurl)<100 :
                aug_ratio = 200/len(img_list_dataurl)
    ...
    def processFrame(self, cam_id):
        ...
        while True:
            ...
            for idxx, bb in enumerate(bbs):
                ...
                max_tracking_count_for_unknown = 3
                ...
                if (not self.training and len(self.prev_bbs[cam_id])>0 and 
                    ...
                    (self.prev_identity[cam_id][matchingresult[0]] >= 0 or (self.prev_identity[cam_id][matchingresult[0]] == -1 and counter % max_tracking_count_for_unknown !=0))):
