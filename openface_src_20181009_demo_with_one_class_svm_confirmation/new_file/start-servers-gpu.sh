...
#./demos/web/websocket-server.py --verbose --cuda --unknown True --port $WEBSOCKET_PORT 2>&1 | tee $WEBSOCKET_LOG &
export LANG=en_US.UTF-8

# Use this in openshift
./demos/web/websocket-server.py --verbose --cuda --port $WEBSOCKET_PORT 2>&1 | tee $WEBSOCKET_LOG &

# Use this in docker of local machine
#./demos/web/websocket-server.py --verbose --port $WEBSOCKET_PORT 2>&1 | tee $WEBSOCKET_LOG &
