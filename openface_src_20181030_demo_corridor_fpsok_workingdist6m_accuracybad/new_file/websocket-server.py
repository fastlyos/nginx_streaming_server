...
class OpenFaceServerProtocol(WebSocketServerProtocol):
    def __init__(self):
        ...
        self.ui_size_x = 816 #640 #816 #160 #384 #816 # 320
        self.ui_size_y = 459  #360 #459 # 90 # 216 #459 #180
    ...
    def Determine_identity_by_rep(self, cam_id, rep):
        ...
        if len(self.people) == 0:
            ...
            if self.svm:
                ...
                print("[cam{}] max svm prob is {} , of identity {} at class index {}, called [{}]".format(cam_id, max(prob), identity, np.argmax(prob), self.people[self.identity_ofppl.index(identity)]))
            ...
            #     print("[cam{}] knn prob of each class: {}".format(cam_id, ' '.join(str(e)[:6] for e in prob)))
            #     print("[cam{}] max knn prob is {} , of identity {} at class index {}, called [{}]".format(cam_id, max(prob), identity, np.argmax(prob), self.people[self.identity_ofppl.index(identity)]))
            ...
            if identity >= 0:
                if self.mean and self.std:
                    ...
                    BestMatchSimilarityScoreThd = 0.7
