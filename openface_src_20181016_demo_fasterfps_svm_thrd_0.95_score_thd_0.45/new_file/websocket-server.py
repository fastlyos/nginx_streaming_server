...
class OpenFaceServerProtocol(WebSocketServerProtocol):
        ...
        if len(self.people) == 0:
            ...
            if identity >= 0:
                if self.mean and self.std:
                    ...
                    BestMatchSimilarityScoreThd = 0.45
    ...
    def AugmentThread(self, id, identity, aug_num, img):
        ...
        start = time.time()
        images_aug = seq.augment_images([img]*aug_num)
    ...
    def matching(self, cam_id, bb, bbs_ref, identitylist):
        ...
        for idx, bbb in enumerate(bbs_ref):
            ...
            if self.prev_bbs_isused[cam_id][idx] == 0 and dist < min_dist and identitylist[idx] != -99:
                min_dist = dist
                index = idx
