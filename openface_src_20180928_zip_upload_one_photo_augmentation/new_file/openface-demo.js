...
function getPeopleInfoHtml()
{
    ...
    for (var i = 0; i < len; i++)
    {
        ...
        h += "<input type='radio' id='m" + identity_ofppl[i] + "' value='" + identity_ofppl[i] + "'>";
        h += "</li>";
            ...
            if(j.content != "None")
            {
                ...
                for(var z=0; z<j.content.length; z++)
                {
                    ...
                    if(j.content[z][6])
                    {
                        ...
                        ppcanvas.height = display_image_size;
                        var ppctx = ppcanvas.getContext('2d');
                        ppctx.drawImage(vid_now, j.content[z][1]*ratio_x, j.content[z][2]*ratio_y, j.content[z][3]*ratio_x, j.content[z][4]*ratio_y,
