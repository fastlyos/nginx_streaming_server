...
class OpenFaceServerProtocol(WebSocketServerProtocol):
    def __init__(self):
        ...
        self.ui_size_x = 320 #816 #160 #384 #816 # 320
        self.ui_size_y = 180 #459 # 90 # 216 #459 #180
        ...
        self.encodedimage = []
        self.processed_msg = Queue.Queue()
        ...
        if msg['type'] == "ALL_STATE":
            ...
            if len(self.cap) > 0:
                ...
                for zzz in range(0, len(self.video_stream_path)):
                    ...
                    self.bufferframe.append(Queue.Queue())
            ...
            # phash = str(imagehash.phash(Image.fromarray(resizedphoto)))
            # rep = cpunet.forward(resizedphoto)

            # content = [str(x) for x in cv2.resize(resizedphoto, (0,0),
            #     fx=0.5, fy=0.5).flatten()]   
