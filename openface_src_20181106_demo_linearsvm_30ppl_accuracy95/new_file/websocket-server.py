...
class OpenFaceServerProtocol(WebSocketServerProtocol):
    def __init__(self):
        ...
        self.BestMatchSimilarityScoreThd = 0.7
        self.BestMatchSimilarityScoreThd_reconfirm = 0.5
    ...
    def matching(self, cam_id, bb, bbs_ref, identitylist):
        ...
        if match_count >= 2:
            NeedReConfirm = True
            print("[cam{}] match_count = {}, possible matching boundingbox num > 1, need re-confirm".format(cam_id, match_count))            
    ...
    def loadState(self, jsImages, training, jsPeople, jsIdentity):
        ...
        for jsImage in jsImages:
            ...
            if rep == "0":
            #if True:
                print("The image {} of identity {} has no representation, need to recalculate!".format(counter, jsImage['identity']))
    ...
    def processFrame(self, cam_id):
        ...
        while True:
            ...
            if not self.training and len(true_bbs) > 0 and not StopUpdatePrev:
